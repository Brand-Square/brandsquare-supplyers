...
import { useProducts } from "@/lib/customHooks/useReactQueryProductStoreHooks";
...
const AllProductsPage = () => {
  ...
  // Use the React Query hook to fetch products with pagination
  const { data: productResponse, isLoading, error } = useProducts(currentPage);
  ...
  return (
    <>
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Pagination - using the provided Pagination component */}
